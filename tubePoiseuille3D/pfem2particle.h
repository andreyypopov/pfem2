...
public:
	...
	Vector<double> solutionVx, solutionVy, solutionVz, solutionP, correctionVx, correctionVy, correctionVz, predictionVx, predictionVy, predictionVz;	//!< Вектор решения, коррекции и прогноза на текущем шаге по времени
